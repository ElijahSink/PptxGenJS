...
## [4.1.1](https://github.com/ElijahSink/PptxGenJS/releases/tag/v4.1.1) - 2026-08-09

### Changed

- No functional changes. Version bump to exercise the tag-triggered release
  workflow end to end, including trusted-publishing authentication
  ([ElijahSink](https://github.com/ElijahSink))

## [4.1.0](https://github.com/ElijahSink/PptxGenJS/releases/tag/v4.1.0) - 2026-08-09

> First release of the `@ejsink/pptxgenjs` fork, tracking upstream v4.0.1.

### Added

- Slide transitions via `slide.transition` or `addSlide({ transition })`, covering all 21 OOXML
  transition types with per-type direction typing ([ElijahSink](https://github.com/ElijahSink))
